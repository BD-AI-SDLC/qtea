...
See CLAUDE.md § JIT Locator Resolution and `agents/qa-orchestrator.instructions.md` § Steps 2/3/7/8/9/10 for the full contracts.
...
- `test-architect` emits `code-modification-plan.json` that step 8 transpiles directly — no re-derivation of placement.
