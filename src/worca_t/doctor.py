"""`worca-t doctor` - environment / dependency health checks."""
...
from worca_t.config import get_settings, package_resource_root
from worca_t.mcp_manager import load_mcp_config, probe_server
from worca_t.proxy import detected_proxies, with_proxy_env
...
def run_doctor(
    *,
    ...
    if json_out:
        ...
        table = Table(title="worca-t doctor", show_lines=False)
