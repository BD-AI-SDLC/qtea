"""HITL bridge: route ``worca_t.hitl.prompt_user`` calls into UI dialogs.
...
import worca_t.hitl as hitl_module
from worca_t.hitl import RESOLUTION_ANSWERED, Question
from worca_t.ui.state import AppState, HitlRequest
