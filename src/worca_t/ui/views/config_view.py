...
from worca_t.ui.theme import BACKGROUND, CARD_BG, DIVIDER, ON_SURFACE, ON_SURFACE_DIM, PRIMARY, SECONDARY
...
def build_config_view(
    ...
    # ── Skip steps ───────────────────────────────────────────────────────
    from worca_t.ui.state import STEP_DEFINITIONS
    ...
    from worca_t.ui.state import STEP_DEFINITIONS as _STEPS
    from worca_t.ui.workspaces import get_workspace, list_workspaces
