...
/**
 * Sentinel helper for the worca-t JIT locator runtime (Java + Playwright).
 *
 ...
 * string that {@link WorcaT}'s page proxy intercepts at runtime.
 *
 * <p>Mirrors the Python and TypeScript sentinel layout exactly:
 * {@code __WORCA_T_TBD__::<intent>}. A single resolver subprocess /
 ...
 * {@code page} is a {@link WorcaT#wrap(com.microsoft.playwright.Page) wrapped}
...
public final class Tbd {
    ...
    public static final String SENTINEL_PREFIX = "__WORCA_T_TBD__::";
     ...
     * @return a sentinel string that {@link WorcaT#wrap(com.microsoft.playwright.Page)}'s
